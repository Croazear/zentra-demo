  ...
  const upcomingDeadlines = [
    {
      date: "20",
      month: "LUT",
      title: "ZUS (Składka społeczna)",
      detail: "Przelew 1 600,00 PLN",
                ...
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                  {MOCK_DOCUMENTS.slice(0, 4).map((doc) => (
                    ...
                    >
                      ...
                      <td className="px-8 py-5">
                        <span
                          className={`text-[10px] font-bold px-3 py-1 rounded-full whitespace-nowrap ${getStatusStyle(doc.status)}`}
                        >
                          {getStatusLabel(doc)}
                        </span>
                      </td>
            ...
            <div className="space-y-3">
              {tasks.slice(0, 4).map((task) => (
                ...
                >
                  ...
                  <span
                    className={`text-sm font-medium leading-tight ${task.completed ? "text-slate-300 line-through italic" : "text-slate-700 dark:text-slate-300"}`}
                  >
                    {task.title}
                  </span>
                </div>
